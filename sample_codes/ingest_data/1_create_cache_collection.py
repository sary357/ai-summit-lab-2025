...
# gpt-4o-mini
def create_milvus_cache_collection(host_name, port, db_name, collection_name, dim, max_text_length=65535, collection_ttl=0):
    client = MilvusClient(
...
if __name__ == "__main__":
    collection = create_milvus_cache_collection(MILVUS_HOST, MILVUS_PORT, CACHE_DB_NAME, CACHE_COLLECTION_NAME, DIMENSION, max_text_length=65535, collection_ttl=CACHE_COLLECITON_DEFAULT_TTL )
